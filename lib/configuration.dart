...
import 'package:comscore_analytics_flutter/partner_configuration.dart';
import 'package:comscore_analytics_flutter/publisher_configuration.dart';
import 'package:comscore_analytics_flutter/live_transmission_mode.dart';
import 'package:comscore_analytics_flutter/offline_cache_mode.dart';
import 'package:comscore_analytics_flutter/usage_properties_auto_update_mode.dart';
...
class Configuration {
  ...
  final List<OnCrossPublisherUniqueDeviceIdChange> _onCrossPublisherUniqueDeviceIdChangeListenerList = [];

  Future<void> addClient(ClientConfiguration? client) async {
    if (client == null) {
      return;
    }
    await methodChannel.invokeMethod<void>('addClient', {Args.refId: client.refId});
  }
  ...
  void addCrossPublisherUniqueDeviceIdChangeListener(OnCrossPublisherUniqueDeviceIdChange callback) async {
    ...
    if (_crossPublisherUniqueDeviceIdChangeStream == null) {
      _crossPublisherUniqueDeviceIdChangeStream = EventChannelStreamHelper().getStream(
        EventChannelStreamHelper.crossPublisherChangeListenerEventChannel,
      );
      _crossPublisherUniqueDeviceIdChangeStream!.listen((event) {
        for (var callback in _onCrossPublisherUniqueDeviceIdChangeListenerList) {
          callback(event);
        }
      });
      methodChannel.invokeMethod('addCrossPublisherUniqueDeviceIdChangeListener');
    }
  }

  void removeCrossPublisherUniqueDeviceIdChangeListener(OnCrossPublisherUniqueDeviceIdChange callback) {
  ...
  Future<PartnerConfiguration?> getPartnerConfiguration(String partnerId) async {
    String? refId = await methodChannel.invokeMethod('getPartnerConfiguration', {Args.partnerId: partnerId});
    if (refId == null) {
      return null;
    }
  ...
  Future<PublisherConfiguration?> getPublisherConfiguration(String publisherId) async {
    String? refId = await methodChannel.invokeMethod('getPublisherConfiguration', {Args.publisherId: publisherId});
    if (refId == null) {
      return null;
    }
  ...
  Future<List<PublisherConfiguration>> getPublisherConfigurations() async {
    List? refIdList = await methodChannel.invokeMethod('getPublisherConfigurations');
    if (refIdList == null) {
      return [];
    }
  ...
  Future<List<PartnerConfiguration>> getPartnerConfigurations() async {
    List? refIdList = await methodChannel.invokeMethod('getPartnerConfigurations');
    if (refIdList == null) {
      return [];
    }
  ...
  Future<void> setLabelOrder(List<String> labelOrder) {
    return methodChannel.invokeMethod('setLabelOrder', {Args.labelOrder: labelOrder});
  }

  /// Sets the live end point URL.
  /// @param liveEndpointUrl Live Endpoint URL
  Future<void> setLiveEndpointUrl(String liveEndpointUrl) {
    return methodChannel.invokeMethod('setLiveEndpointUrl', {Args.liveEndpointUrl: liveEndpointUrl});
  }
  ...
  Future<void> setApplicationName(String appName) {
    return methodChannel.invokeMethod('setApplicationName', {Args.appName: appName});
  }
  ...
  Future<void> setApplicationVersion(String appVersion) {
    return methodChannel.invokeMethod('setApplicationVersion', {Args.appVersion: appVersion});
  }
  ...
  Future<void> setPersistentLabel(String name, String value) {
    return methodChannel.invokeMethod('setPersistentLabel', {Args.labelName: name, Args.labelValue: value});
  }
  ...
  Future<void> addPersistentLabels(Map<String, String> labels) {
    return methodChannel.invokeMethod('addPersistentLabels', {Args.labels: labels});
  }
  ...
  Future<void> setStartLabel(String name, String value) {
    return methodChannel.invokeMethod('setStartLabel', {Args.labelName: name, Args.labelValue: value});
  }
  ...
  Future<void> setKeepAliveMeasurementEnabled(bool enabled) {
    return methodChannel.invokeMethod('setKeepAliveMeasurementEnabled', {Args.enabled: enabled});
  }
  ...
  Future<void> setLiveTransmissionMode(LiveTransmissionMode liveTransmissionMode) {
  ...
  Future<void> setOfflineCacheMode(OfflineCacheMode offlineCacheMode) {
    return methodChannel.invokeMethod('setOfflineCacheMode', {Args.offlineCacheMode: offlineCacheMode.mode});
  }
  ...
  Future<void> setUsagePropertiesAutoUpdateMode(UsagePropertiesAutoUpdateMode usagePropertiesAutoUpdateMode) {
  ...
  Future<void> setUsagePropertiesAutoUpdateInterval(int interval) {
    return methodChannel.invokeMethod('setUsagePropertiesAutoUpdateInterval', {Args.interval: interval});
  }
  ...
  Future<void> setCacheMinutesToRetry(int minutes) {
    return methodChannel.invokeMethod('setCacheMinutesToRetry', {Args.minutes: minutes});
  }
  ...
  Future<void> addIncludedPublisher(String publisherId) {
    return methodChannel.invokeMethod('addIncludedPublisher', {Args.publisherId: publisherId});
  }
  ...
  Future<void> setSystemClockJumpDetectionPrecision(int precision) {
    return methodChannel.invokeMethod('setSystemClockJumpDetectionPrecision', {Args.precision: precision});
  }

...
class EventChannelStreamHelper {
  static final EventChannelStreamHelper _instance = EventChannelStreamHelper._internal();
  ...
  EventChannelStreamHelper._internal() {
    if (kIsWeb) {
      _streamControllers[crossPublisherChangeListenerEventChannel] = StreamController();
      _streamControllers[streamingStateChangeListenerEventChannel] = StreamController();
    } else {

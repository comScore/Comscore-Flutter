import 'package:comscore_analytics_flutter/configuration.dart';
import 'package:comscore_analytics_flutter/event_info.dart';
import 'package:comscore_analytics_flutter/log_level.dart';
import 'package:comscore_analytics_flutter/utils/connector.dart';
...
class Analytics {
  ...
  ///
  /// @param eventInfo Information to send in the event.
  static Future<void> notifyHiddenEvent({EventInfo? eventInfo, Map<String, String>? labels}) {
    var args = <String, dynamic>{Args.eventInfoRefId: eventInfo?.refId, Args.labels: labels};
  ...
  static Future<void> notifyDistributedContentViewEvent(String distributorPartnerId, String distributorContentId) {
    var args = <String, dynamic>{
      Args.distributorPartnerId: distributorPartnerId,
      Args.distributorContentId: distributorContentId
    };
    return _methodChannel.invokeMethod<void>('notifyDistributedContentViewEvent', args);
  }
}

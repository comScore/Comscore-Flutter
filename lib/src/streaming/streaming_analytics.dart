...
import 'package:comscore_analytics_flutter/src/streaming/streaming_configuration.dart';
import 'package:comscore_analytics_flutter/src/streaming/streaming_extended_analytics.dart';
import 'package:comscore_analytics_flutter/src/streaming/streaming_publisher_configuration.dart';
import 'package:comscore_analytics_flutter/src/streaming/streaming_state.dart';
...
import 'package:comscore_analytics_flutter/src/utils/trackable_object_extension.dart';
...
class StreamingAnalytics extends TrackableObject {
  static const _methodChannel = MethodChannel(
    "com.comscore.streaming.streamingAnalytics",
  );
  static Stream? _onStreamingStateChangeStream;
  static final Map<String, List<OnStreamingStateChange>>
  _onStreamingStateChangeListenerMap = {};
  ...
  StreamingAnalytics._init(
    super.streamingAnalyticsRefId,
    String streamingConfigurationRefId,
  ) {
  ...
  static Future<StreamingAnalytics?> build({
    ...
    return StreamingAnalytics._init(
      refIds["streamingAnalyticsRefId"],
      refIds["streamingConfigurationRefId"],
    );
  }

  Future<StreamingExtendedAnalytics?> getExtendedAnalytics() async {
    if (_extendedAnalytics == null) {
      var refId = await _methodChannel.invokeMethod<String>(
...
class _StreamingConfigurationImpl extends TrackableObject
    implements StreamingConfiguration {
  static const _methodChannel = MethodChannel(
    "com.comscore.streaming.streamingConfiguration",
  );

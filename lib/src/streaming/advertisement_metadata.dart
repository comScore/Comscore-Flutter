import 'package:comscore_analytics_flutter/src/streaming/advertisement_delivery_type.dart';
import 'package:comscore_analytics_flutter/src/streaming/advertisement_owner.dart';
import 'package:comscore_analytics_flutter/src/streaming/advertisement_type.dart';
import 'package:comscore_analytics_flutter/src/streaming/asset_metadata.dart';
import 'package:comscore_analytics_flutter/src/streaming/content_metadata.dart';
import 'package:comscore_analytics_flutter/src/streaming/stacked_advertisement_metadata.dart';
...
class AdvertisementMetadata extends AssetMetadata {
  ...
  static AdvertisementMetadataBuilder builder() =>
...
class AdvertisementMetadataBuilder {
  ...
  AdvertisementMetadataBuilder stack(
    Map<String, StackedAdvertisementMetadata> stack,
  ) {
    _stack = stack;
    return this;
  ...
  AdvertisementMetadataBuilder relatedContentMetadata(
    ContentMetadata relatedContentMetadata,
  ) {
  ...
  AdvertisementMetadataBuilder classifyAsAudioStream(
    bool classifyAsAudioStream,
  ) {
  ...
  AdvertisementMetadataBuilder deliveryType(
    AdvertisementDeliveryType deliveryType,
  ) {

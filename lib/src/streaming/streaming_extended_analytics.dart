import 'package:comscore_analytics_flutter/src/streaming/window_state.dart';
...
class StreamingExtendedAnalytics extends TrackableObject {
  static const _methodChannel = MethodChannel(
    "com.comscore.streaming.streamingExtendedAnalytics",
  );
  ...
  /// @param labels Labels
  ///
  Future<void> notifyTransferPlayback(
    String targetDevice, [
    Map<String, String>? labels,
  ]) {
    var args = buildArguments();
  ...
  /// @param labels Labels
  ///
  Future<void> notifyChangeAudioTrack(
    String newAudio, [
    Map<String, String>? labels,
  ]) {
    var args = buildArguments();
  ...
  Future<void> setPlaybackSessionExpectedLength(int expectedTotalLength) {
    ...
    return _methodChannel.invokeMethod<void>(
      'setPlaybackSessionExpectedLength',
      args,
    );
  }
  ...
  ///
  Future<void> setPlaybackSessionExpectedNumberOfItems(
    int expectedNumberOfItems,
  ) {
    var args = buildArguments();
    args["expectedNumberOfItems"] = expectedNumberOfItems;
    return _methodChannel.invokeMethod<void>(
      'setPlaybackSessionExpectedNumberOfItems',
      args,
    );
  }
  ...
  ///
  Future<void> notifyChangeVolume(
    double newVolume, [
    Map<String, String>? labels,
  ]) {
    var args = buildArguments();

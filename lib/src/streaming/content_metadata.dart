import 'package:comscore_analytics_flutter/src/streaming/content_type.dart';
import 'package:comscore_analytics_flutter/src/streaming/streaming_date.dart';
import 'package:comscore_analytics_flutter/src/streaming/asset_metadata.dart';
...
import 'package:comscore_analytics_flutter/src/streaming/content_feed_type.dart';
...
import 'package:comscore_analytics_flutter/src/streaming/stacked_content_metadata.dart';
import 'package:comscore_analytics_flutter/src/streaming/streaming_dimensions.dart';
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      "contentDeliveryAdvertisementCapability":
          deliveryAdvertisementCapability?.value,
...
class ContentMetadataBuilder {
  ...
  ContentMetadataBuilder classifyAsCompleteEpisode(
    bool classifyAsCompleteEpisode,
  ) {
    _classifyAsCompleteEpisode = classifyAsCompleteEpisode;
    return this;
  }

  ContentMetadataBuilder carryTvAdvertisementLoad(
    bool carryTvAdvertisementLoad,
  ) {
  ...
  ContentMetadataBuilder dictionaryClassificationC3(
  ...
  ContentMetadataBuilder dictionaryClassificationC4(
  ...
  ContentMetadataBuilder dictionaryClassificationC6(
  ...
  ContentMetadataBuilder deliverySubscriptionType(
  ...
  ContentMetadataBuilder deliveryComposition(
  ...
  ContentMetadataBuilder deliveryAdvertisementCapability(
  ...
  ContentMetadataBuilder distributionModel(
